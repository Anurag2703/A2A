# Purpose:
#     This file defines a reusable, asynchronous Python client for interacting with an Agent2Agent (A2A) server.
#     It supports:
...
from typing import Any              # Type hints for flexible I/O
...
# ------------------------------------------------------------------
# 3. A2AClient: Main interface for talking to an A2A agent
# ------------------------------------------------------------------
...
class A2AClient:
    ...
    async def send_task(self, payload: dict [str, Any]) -> Task:
        ...
        return Task(**response ["result"])      # Fix: extract just the 'result' field


    # ------------------------------------------------------------------
    # get_task: Retrieve the status or history of a previously sent_task
    # ------------------------------------------------------------------
