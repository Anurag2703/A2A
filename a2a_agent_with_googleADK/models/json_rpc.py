...
class InternalError(JSONRPCError):
    code: int = -32603                  # Fixed error code for internal errors
    message: str = "Internal error"     # Default error message describing the type of error
    data: Any | None = None             # Optional debug details (e.g., traceback or context info)