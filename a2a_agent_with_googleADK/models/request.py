...
#       such as sending a task or retrieving a task. Each request adheres to the JSON-RPC 2.0 format.
#     It also includes a discriminated union called 'A2ARequest, which automatically identifies and 
#       parses the request based on the method field.
