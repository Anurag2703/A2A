...
# These classes help describe the agent's identity, its features, and how it interacts with other agents or 
# clients in a structured and consistent way.
...
class AgentSkill(BaseModel):
    ...
    tags: List[str] | None = None   # Optional tags to help categorize or search for the skill
