# Purpose:
#     This file is a command-line interface (CLI) that lets users interact with the TellTimeAgent 
#     running on an A2A server.

#     It sends simple text messages (like "What time is it?") to the agent, waits for a response, 
