# Purpose:
    # This file connects the Gemini-powered agent TellTimeAgent) to the task-handling system.
...
# This allows to print nice logs like:
...
class AgentTaskManager(InMemoryTaskManager):
    ...
    # -------------------------------------------------
    # Initialization of Task_Manager
    #-------------------------------------------------
    ...
    async def on_send_task(self, request: SendTaskRequest) -> SendTaskResponse:
        ...
        agent_message = Message(
            ...
            parts = [TextPart(text = result_text)]  # The reply text is stores inside a TextPart
        )
